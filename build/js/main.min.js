...
/* harmony import */ var _modules_show_more_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/show-more-elements */ "./js/modules/show-more-elements.js");
...
/* harmony import */ var _modules_breakpoint_checker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/breakpoint-checker */ "./js/modules/breakpoint-checker.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_2__["accordionToggle"])();
  Object(_modules_breakpoint_checker__WEBPACK_IMPORTED_MODULE_3__["breakpointChecker"])();
  detailsButton.addEventListener('click', _modules_show_more_elements__WEBPACK_IMPORTED_MODULE_1__["onDetailsButtonClick"]);
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_4__["addListenersOnForm"])();
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_5__["addHandlersOnModal"])();
}); // ---------------------------------
...
var accordionsTitles = document.querySelectorAll('[data-title=accordion-title]');
...
var accordionToggle = function accordionToggle() {
  ...
  accordionsTitles.forEach(function (accordionTitle) {
    accordionTitle.addEventListener('click', function () {
      var currentAccordionTitle = accordionTitle;
      var accordionTitleId = currentAccordionTitle.getAttribute('data-accordion');
      var currentAccordionContent = document.querySelector(accordionTitleId);
...
var headingProducts = document.querySelector('#heading-products');

var replacingTextOnElement = function replacingTextOnElement(element, text) {
...
var breakpointChecker = function breakpointChecker() {
  if (breakpoint.matches) {
    ...
    var hiddenContent = document.querySelector('[data-hidden="hidden"]');
...
var buttonSubmitForm = document.querySelector('#button-submit');
var TEL_LENGTH = 16;
...
var addListenerOnCheckboxChange = function addListenerOnCheckboxChange() {
...
/*!*****************************!*\
  !*** ./js/modules/modal.js ***!
  \*****************************/
/*! exports provided: addHandlersOnModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addHandlersOnModal", function() { return addHandlersOnModal; });
var buttonOpenModal = document.querySelector('#button-open-modal');
var modal = document.querySelector('#modal');
var overlay = document.querySelector('#overlay');
var buttonClose = modal.querySelector('#button-close');
var inputName = modal.querySelector('#name-field-modal');
...
var onEscKeyClick = function onEscKeyClick(evt) {
  if (evt.key === 'Escape') {
    closeModal();
  }
};

var addHandlersOnModal = function addHandlersOnModal() {
...
var detailsItems = document.querySelectorAll('[data-content=details-item]');

var onDetailsButtonClick = function onDetailsButtonClick(button) {
